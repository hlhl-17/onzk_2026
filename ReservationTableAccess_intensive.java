...
public class ReservationTableAccess_intensive extends Simulation {
    ...
    private static final ScenarioBuilder reservationScenario = scenario("ReservationTotalAccess_intensive")
            .exec(requestGroup);
    ...
    private static OpenInjectionStep[] setupDefinitions() {
        return new OpenInjectionStep[] {
                ...
                // 7350 req数 (7 API/1シナリオ -> 約 210 scn/min)
                constantUsersPerSec(210.0 / 60.0).during(Duration.ofMinutes(5))
        };
    }
